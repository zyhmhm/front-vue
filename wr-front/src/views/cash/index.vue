    ...
    <div class="app-container">
      ...
      >
       ...
       <el-table-column label="提货人姓名" width="100px">
        ...
        <el-table-column label="兑付日期" width="260px" align="center">
          <template slot-scope="{row}">
        ...
        <el-table-column :label="$t('appointment.actions')" align="center" width="250" class-name="small-padding fixed-width">
          <template slot-scope="{row,$index}">
            ...
            <el-button v-show="row.state === 3" type="danger" size="mini" @click="doOutRepo(row)">
              出库
            </el-button>
          </template>
        </el-table-column>
...
<script>
import { doGetCashPage, doAcceptOrRefuse } from '@/api/cash'
...
export default {
  ...
  methods: {
    ...
    doSubmit() {
      ...
      this.postData.notes = this.notes.notes
    ...
    getList() {
      ...
      doGetCashPage(this.listQuery).then(response => {
